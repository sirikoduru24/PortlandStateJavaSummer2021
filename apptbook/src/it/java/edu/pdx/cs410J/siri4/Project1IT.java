...
//    MainMethodResult result = invokeMain(Project1.class, "-prt", "siri", "Have dinner", "7/15/2021", "04:39", "7/15/2021", "14:39");
//    assertThat(result.getTextWrittenToStandardError(), containsString(Project1.TOO_MANY_ARGS_NO_OPTIONS));
//    assertThat(result.getTextWrittenToStandardError(),containsString(Project1.USAGE_MSG));
//  }
//
...
//    MainMethodResult result = invokeMain(Project1.class, "-print", "Test8", "Have dinner", "03/03/2021", "12:00", "01/04/2021", "6:00");
//    assertThat(result.getTextWrittenToStandardError(), containsString("Have dinner from 03/03/2021 12:00 until 01/04/2021 16:00"));
//  }
//
//  @Test
